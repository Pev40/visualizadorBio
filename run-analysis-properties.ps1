# Script para ejecutar analisis usando el archivo sonar-project.properties
...
# Ejecutar analisis usando Docker con el archivo de propiedades
Write-Host "Iniciando analisis..." -ForegroundColor Green
try {
    # Usar el comando docker run que lea el archivo sonar-project.properties
    docker run --rm `
